 ...
 * @author 
 */
public class TbHisMedicalRecordTjDate extends TbHisMedicalRecordTjDateKey implements Serializable {
    /**
     * 接诊数量
     */
    ...
    public boolean equals(Object that) {
        ...
        TbHisMedicalRecordTjDate other = (TbHisMedicalRecordTjDate) that;
