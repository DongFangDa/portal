...
/**
 * TB_SERVICE_APP_STATISTIC
 * @author 
 */
public class TbServiceAppStatistic implements Serializable {
    /**
     * 当前统计日期
     */
    ...
    public BigDecimal getYYJZCS() {
        return YYJZCS;
    }

    public void setYYJZCS(BigDecimal YYJZCS) {
        this.YYJZCS = YYJZCS;
    }
    ...
    public String getGLSQZXBM() {
        return GLSQZXBM;
    }

    public void setGLSQZXBM(String GLSQZXBM) {
        this.GLSQZXBM = GLSQZXBM;
    }
    ...
    public boolean equals(Object that) {
        ...
        TbServiceAppStatistic other = (TbServiceAppStatistic) that;
        return (this.getTJ_TIME() == null ? other.getTJ_TIME() == null : this.getTJ_TIME().equals(other.getTJ_TIME()))
            ...
            && (this.getYYJZCS() == null ? other.getYYJZCS() == null : this.getYYJZCS().equals(other.getYYJZCS()))
            && (this.getYYGHCS() == null ? other.getYYGHCS() == null : this.getYYGHCS().equals(other.getYYGHCS()))
            && (this.getGLSQZXBM() == null ? other.getGLSQZXBM() == null : this.getGLSQZXBM().equals(other.getGLSQZXBM()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getYYJZCS() == null) ? 0 : getYYJZCS().hashCode());
        result = prime * result + ((getYYGHCS() == null) ? 0 : getYYGHCS().hashCode());
        result = prime * result + ((getGLSQZXBM() == null) ? 0 : getGLSQZXBM().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", YYJZCS=").append(YYJZCS);
        sb.append(", YYGHCS=").append(YYGHCS);
        sb.append(", GLSQZXBM=").append(GLSQZXBM);
